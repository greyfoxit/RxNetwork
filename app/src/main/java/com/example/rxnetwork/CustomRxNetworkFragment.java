...
/**
 * Fragment with customized RxNetwork.
 */
public class CustomRxNetworkFragment extends RxNetworkFragment {

  private static final String TAG = CustomRxNetworkFragment.class.getSimpleName();
